...
export default function EyeSpaLandingLT() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.privacy) errors.privacy = "Turite sutikti su privatumo politika";
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-6 z-10">
            ...
            <div className="flex items-center gap-4 bg-white p-4 rounded-xl border border-slate-100 shadow-sm max-w-sm">
              ...
              <div className="flex flex-col">
                 <span className="text-xs font-bold text-red-500 bg-red-50 px-2 py-1 rounded">-50% ŠIANDIEN</span>
                ...
                <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-6">
                  ...
                  <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    <span className={`text-sm ${formErrors.privacy ? 'text-red-500' : 'text-slate-600'}`}>
                      Perskaičiau ir sutinku su Privatumo politika ir Pardavimo sąlygomis.
                    </span>
                  </label>
