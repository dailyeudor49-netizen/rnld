...
export default function EyeSpaLandingPT() {
  ...
  return (
    <div className="min-h-screen bg-white pb-20 md:pb-0">
      ...
      <img src="https://offers.adricenetwork.com/forms/api/ck/?o=3455&uid=019a913a-422a-770d-8b80-6aa9c3b58776&lp=3491" style={{ width: '1px', height: '1px', display: 'none' }} alt="" />
