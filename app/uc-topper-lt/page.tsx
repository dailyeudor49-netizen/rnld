...
export default function TopperOrtopedicoLandingLT() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      ...
      <img src="https://offers.adricenetwork.com/forms/api/ck/?o=3041&uid=019a913a-422a-770d-8b80-6aa9c3b58776&lp=3075" style={{ width: '1px', height: '1px', display: 'none' }} alt="" />
