...
export default function RobotAspirapolvereProLanding() {
  ...
  const comparisonData = [
    ...
    { feature: "Prezzo totale", robot: "€79 CON STAZIONE", without: "€500+ per le stesse funzioni" },
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Sì, la spazzola anti-groviglio è progettata per peli e capelli lunghi. Non si inceppa mai. Oltre 800 clienti con animali lo confermano."
    },
    {
  ...
  const reviews = [
    { nome: 'Marek K.', paese: 'Polonia', flag: '🇵🇱', testo: 'Tre cani di grossa taglia. Aspiravo OGNI GIORNO. Con questo robot, passo l\'aspirapolvere una volta a SETTIMANA per gli angoli. Il 90% del lavoro lo fa lui. Miglior acquisto degli ultimi 5 anni.', stelle: 5, data: '5 giorni fa', risposta: 'Marek, grazie! I proprietari di animali sono i nostri clienti più soddisfatti.' },
    { nome: 'Jana N.', paese: 'Slovacchia', flag: '🇸🇰', testo: 'Mio marito era scettico. "A questo prezzo sarà un giocattolo". Dopo 2 settimane mi ha chiesto scusa. Pulisce MEGLIO del nostro vecchio Roomba da €600. La stazione che svuota da sola è geniale.', stelle: 5, data: '1 settimana fa' },
    { nome: 'Petr S.', paese: 'Rep. Ceca', flag: '🇨🇿', testo: 'Appartamento di 85mq su due livelli. Lo porto su e giù e fa tutto lui. Batteria infinita, mai dovuto interromperlo a metà. Silenziosissimo, lo faccio andare mentre lavoro da casa.', stelle: 5, data: '3 giorni fa', risposta: 'Petr, esatto! La batteria da 5200mAh garantisce fino a 6 ore!' },
    { nome: 'Agneta L.', paese: 'Svezia', flag: '🇸🇪', testo: 'Ho 68 anni e problemi di schiena. Non riesco più a passare l\'aspirapolvere. Questo robot mi ha cambiato la vita. Lo programmo e lui fa tutto. Finalmente posso godermi la casa pulita senza dolori.', stelle: 5, data: '4 giorni fa' },
    { nome: 'Kristaps V.', paese: 'Lettonia', flag: '🇱🇻', testo: 'Allergico agli acari da sempre. Da quando uso questo robot con filtro HEPA, mi sveglio senza naso chiuso. La differenza è ENORME. Avrei dovuto comprarlo anni fa.', stelle: 5, data: '2 settimane fa', risposta: 'Kristaps, il filtro HEPA H13 fa davvero la differenza per chi soffre di allergie!' },
    { nome: 'Tomasz W.', paese: 'Polonia', flag: '🇵🇱', testo: 'Ho confrontato questo con il Roborock da €900 di mio cognato. STESSE FUNZIONI. Lui non ci credeva. Gli ho fatto vedere la stazione che svuota e lava. Ora ne vuole uno anche lui.', stelle: 5, data: '1 settimana fa' },
    { nome: 'Erika M.', paese: 'Estonia', flag: '🇪🇪', testo: 'Casa con 3 gatti. I peli erano un incubo. Ora il robot passa 2 volte al giorno e la casa è sempre perfetta. Gli ospiti non credono che ho 3 gatti. IL MIGLIOR REGALO che mi sia mai fatta.', stelle: 5, data: '6 giorni fa' },
    { nome: 'Anders H.', paese: 'Norvegia', flag: '🇳🇴', testo: 'Inverno lungo, casa sempre chiusa. La polvere si accumulava velocemente. Ora il robot pulisce ogni giorno mentre sono al lavoro. Torno a casa e respiro aria pulita. Vale ogni centesimo.', stelle: 5, data: '10 giorni fa', risposta: 'Anders, esattamente! Perfetto per gli inverni nordici.' },
    { nome: 'Liina T.', paese: 'Finlandia', flag: '🇫🇮', testo: 'Capelli lunghi ovunque, era il mio incubo. Questo robot li aspira TUTTI senza incepparsi. La spazzola non si blocca mai. Ho provato 3 robot prima di questo, finalmente uno che funziona!', stelle: 5, data: '8 giorni fa' },
    { nome: 'Henrik B.', paese: 'Danimarca', flag: '🇩🇰', testo: 'Lo uso da 2 mesi, ogni giorno. Zero problemi. La qualità è identica ai robot da €1000. Ho risparmiato una fortuna e ho la casa sempre pulita. Lo consiglio a tutti.', stelle: 5, data: '12 giorni fa', risposta: 'Henrik, grazie per la fiducia! La qualità parla da sola.' },
  ];
      ...
      <section className="bg-gradient-to-b from-gray-900 to-gray-800 pt-6 pb-4 md:py-8 px-4 text-white">
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-red-500 text-white text-sm md:text-base font-bold py-2 px-4 rounded-full inline-block mb-4 animate-pulse">
            LIQUIDAZIONE TOTALE — ULTIMI {stockLeft} PEZZI
          </div>
          ...
          <div className="bg-white/10 backdrop-blur border border-white/20 rounded-xl p-4 inline-block">
            ...
            <span className="text-4xl md:text-5xl font-black text-white ml-3">€79<span className="text-2xl">,99</span></span>
            <span className="block text-green-400 font-bold mt-1">Stazione Auto-Svuotante INCLUSA (vale €599)</span>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 rounded-xl p-5 text-left lg:hidden border border-gray-200">
              <h3 className="text-lg font-black text-gray-800 mb-3 text-center">Perché è diverso dagli altri:</h3>
              <ul className="space-y-3 text-gray-700 text-base">
                <li className="flex items-start gap-3">
                  <Sparkles className="w-6 h-6 text-blue-500 flex-shrink-0 mt-0.5" />
                  <span><strong className="text-gray-800">Aspira e lava insieme</strong> — Un passaggio, pavimenti perfetti.</span>
                </li>
                <li className="flex items-start gap-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-gray-800">Addio peli e capelli</strong> — Spazzola anti-groviglio, non si blocca mai.</span>
                </li>
                <li className="flex items-start gap-3">
                  <ShieldCheck className="w-6 h-6 text-green-600 flex-shrink-0 mt-0.5" />
                  <span><strong className="text-gray-800">Aria pulita</strong> — Filtro HEPA cattura 99.97% allergeni.</span>
                </li>
                <li className="flex items-start gap-3">
                  <Navigation className="w-6 h-6 text-purple-500 flex-shrink-0 mt-0.5" />
                  <span><strong className="text-gray-800">Navigazione laser</strong> — Mappa la casa, non sbatte sui mobili.</span>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-2xl p-5 mb-6 shadow-xl relative overflow-hidden">
              ...
              <div className="bg-gray-50 rounded-xl p-4 mb-4 border border-gray-100">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-gray-400 line-through text-xl">€399,00</span>
                  <span className="bg-green-100 text-green-700 text-xs font-bold px-2 py-1 rounded">RISPARMI €319</span>
                </div>
                <div className="text-center">
                  <span className="text-5xl font-black text-green-700">€79<span className="text-2xl">,99</span></span>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <div className="bg-white rounded-2xl p-5 shadow-md text-center">
              ...
              <p className="text-gray-500 text-sm">Non ti pieghi più. Lui passa ovunque.</p>
            </div>
            <div className="bg-white rounded-2xl p-5 shadow-md text-center">
              <div className="text-3xl mb-2">🧹</div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Il robot torna alla base, si svuota, lava il mocio sporco, si ricarica. È la tua nuova colf personale.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 items-start">
            ...
            >
              <div className="relative aspect-square overflow-hidden">
                <img src="/images/robot-asp/svuota.webp" alt="Auto-svuotamento" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                {/* Desktop overlay */}
                  ...
                  <div className="p-4 text-white w-full">
                    ...
                    <div className={`overflow-hidden transition-all duration-500 ease-in-out ${openFeature === 0 ? 'max-h-40 opacity-100 mt-3' : 'max-h-0 opacity-0'}`}>
                      <p className="text-sm text-white/90 leading-relaxed">
                        Torna alla base e si svuota DA SOLO in un sacchetto da 3 litri. <strong>Cambi il sacchetto ogni 2 mesi.</strong> Mai più mani nella polvere. Mai più starnuti.
                      </p>
                    </div>
              ...
              <div className="md:hidden p-3 bg-gradient-to-r from-blue-600 to-indigo-700">
                ...
                <div className={`overflow-hidden transition-all duration-500 ease-in-out ${openFeature === 0 ? 'max-h-40 opacity-100 mt-2' : 'max-h-0 opacity-0'}`}>
                  <p className="text-sm text-blue-100 leading-relaxed">
                    Torna alla base e si svuota DA SOLO in un sacchetto da 3 litri. Cambi il sacchetto ogni 2 mesi. Mai più mani nella polvere.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="relative aspect-square overflow-hidden">
                <img src="/images/robot-asp/mocio.webp" alt="Lavaggio automatico" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                {/* Desktop overlay */}
                <div className={`hidden md:flex absolute inset-0 items-end transition-all duration-500 ${openFeature === 1 ? 'bg-black/85' : 'bg-gradient-to-t from-black/70 via-black/20 to-transparent'}`}>
                  <div className="p-4 text-white w-full">
                    <div className="flex items-center justify-between">
                      <p className="font-black text-xl leading-tight">MOCIO DEL ROBOT SEMPRE PULITO</p>
              ...
              <div className="md:hidden p-3 bg-gradient-to-r from-blue-600 to-indigo-700">
                <div className="flex items-center justify-between">
                  <p className="font-black text-sm text-white leading-tight">MOCIO DEL ROBOT SEMPRE PULITO</p>
            ...
            >
              <div className="relative aspect-square overflow-hidden">
                <img src="/images/robot-asp/muffa.webp" alt="Asciugatura a caldo" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                {/* Desktop overlay */}
            ...
            >
              <div className="relative aspect-square overflow-hidden">
                <img src="/images/robot-asp/laser.webp" alt="Navigazione LiDAR" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                {/* Desktop overlay */}
            ...
            >
              <div className="relative aspect-square overflow-hidden">
                <img src="/images/robot-asp/divano.webp" alt="Controllo App" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                {/* Desktop overlay */}
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-lg text-gray-600 text-center mb-8">
            Stesse funzioni, €400 in meno. Fai tu i conti.
          </p>
      ...
      <section className="bg-red-600 py-6">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <p className="text-white text-xl font-black mb-3">
            Liquidazione Totale — Solo {stockLeft} pezzi rimasti
          </p>
          <p className="text-white/80 mb-4">Quando finiscono, il prezzo torna a €399. Stazione inclusa solo per questi ultimi pezzi.</p>
          <button
            onClick={openOrderPopup}
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-gray-700 mb-4 text-lg">
                Hai 30 giorni per provarlo. Se non sei ENTUSIASTA — per qualsiasi motivo — ci chiami, mandiamo il corriere a riprenderlo, e ti ridiamo ogni centesimo. <strong>Reso GRATUITO. Zero domande. Zero rischi per te.</strong> Ma il 96% lo tiene.
              </p>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-2xl">
            ...
            <div className="bg-gray-50 rounded-xl p-4 mb-4 border border-gray-200">
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  <span className="text-gray-400 line-through text-sm block">€399</span>
                  <span className="text-3xl font-black text-green-700">€79<span className="text-lg">,99</span></span>
                </div>
              </div>
            </div>
