...
export default function LandingPage() {
  ...
  return (
    <>
      ...
      {/* Click Pixel */}
      <img
        src="https://offers.uncappednetwork.com/forms/api/ck/?o=2920&uid=019a913a-422a-770d-8b80-6aa9c3b58776&lp=2953"
          ...
          <div className="product-info">
            ...
            <div className="product-price">
              <div className="price-row">
                <span className="price-current">1 999 Kč</span>
                <span className="price-original">2 699 Kč</span>
                ...
                <div className="tech-cost-box" style={{
                  ...
                  transition: 'opacity 0.6s ease-out 1s, transform 0.6s ease-out 1s'
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem' }}>
                        <div style={{ fontSize: '1.5rem', fontWeight: 700, color: '#FF8C00' }}>~11 Kč denně</div>
                ...
                <div style={{
                  ...
                  transition: 'opacity 0.6s ease-out 0.8s, transform 0.6s ease-out 0.8s'
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem', paddingTop: '0.75rem', borderTop: '1px solid #e5e7eb' }}>
                        <div style={{ fontSize: '1.25rem', fontWeight: 700, color: '#FF8C00' }}>~11 Kč denně</div>
            ...
            <div style={{ background: 'rgba(255,255,255,0.05)', padding: '2rem', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.1)' }}>
              ...
              <ul style={{ color: '#cbd5e1', listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                  <span>Katalogová cena</span> <span style={{ textDecoration: 'line-through' }}>2 699 Kč</span>
                </li>
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                  <span>Sleva Black Friday</span> <span style={{ color: '#FFB800' }}>-700 Kč</span>
                </li>
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                ...
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '1rem 0', fontSize: '1.25rem', fontWeight: 700, color: 'white' }}>
                  <span>Celkem</span> <span>1 999 Kč</span>
                </li>
              </ul>
          ...
          <div className="sticky-info" style={{
            ...
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <span style={{ fontSize: '1.25rem', fontWeight: 800, color: '#16a34a' }}>1 999 Kč</span>
                <span style={{ fontSize: '0.875rem', textDecoration: 'line-through', color: 'white', opacity: 0.8 }}>2 699 Kč</span>
              </div>
            </div>
          </div>
          <button
