        ...
        <div className="container">
            ...
            <form className="form-card" onSubmit={handleOrderSubmit}>
                ...
                <div id="form-fields" className="form-group">
                    ...
                    <input type="text" name="name" className="input-field" required placeholder="Jonas Jonaitis" value={orderData.name} onChange={handleInputChange} />
                </div>

                <div className="form-group">
                    <label className="input-label">Telefonas (kurjeriui) *</label>
                    <input type="tel" name="phone" className="input-field" required placeholder="+370 612 34567" value={orderData.phone} onChange={handleInputChange} />
                </div>

                <div className="form-group">
                    <label className="input-label">Pilnas adresas *</label>
                    <input type="text" name="address" className="input-field" required placeholder="Gedimino pr. 10, 01103 Vilnius" value={orderData.address} onChange={handleInputChange} />
                </div>
                ...
                <button type="submit" className="red-btn" disabled={isSubmitting}>
                    {isSubmitting ? 'APDOROJAMA...' : 'PATVIRTINTI UŽSAKYMĄ — MOKĖTI KURJERIUI'} <span style={{fontSize:'1.3rem'}}>🚚</span>
                </button>
