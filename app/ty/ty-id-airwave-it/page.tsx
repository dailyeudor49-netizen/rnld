    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Il tuo climatizzatore Air Wave Smart™ è in preparazione e sarà spedito a breve.
        </p>
        ...
        <div style={{
          ...
          Domande? Contattaci: <a href="mailto:info@ketronica.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
