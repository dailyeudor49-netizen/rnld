    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          O seu massajador EyeSpa Pro está a ser preparado e será enviado em breve.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#166534', fontWeight: 600, marginBottom: '0.25rem' }}>NÚMERO DA ENCOMENDA</div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', fontWeight: 700, color: '#1E293B', marginBottom: '1rem' }}>📦 Próximos passos:</div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Preparação da encomenda</div>
              <div style={{ color: '#64748b', fontSize: '0.8rem' }}>Hoje</div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Envio</div>
              <div style={{ color: '#64748b', fontSize: '0.8rem' }}>Dentro de 24 horas</div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem' }}>
            ...
            <div>
              ...
              <div style={{ color: '#64748b', fontSize: '0.8rem' }}>2-3 dias úteis</div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Pagamento na entrega</div>
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Prepare o valor exato para o estafeta</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          Tem questões? Escreva-nos para <a href="mailto:info@ketronica.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
