        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ color: '#6B7280', fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '1.5rem' }}>
              Hiba történt a rendelés megerősítése során. Kérjük, frissítse az oldalt egy kis idő múlva, amíg meg nem jelenik a megerősítés.
            </p>
            <button
      ...
      {popup === 'success' && (
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ color: '#6B7280', fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '1.5rem' }}>
              Elnézést kérünk a korábbi kellemetlenségekért. Rendelése sikeresen megerősítésre került.
            </p>
            <button
