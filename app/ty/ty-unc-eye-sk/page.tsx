    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Váš masážny prístroj EyeSpa Pro sa pripravuje a čoskoro bude odoslaný.
        </p>
        ...
        <div style={{
          ...
          Otázky? Napíšte nám na <a href="mailto:info@ketronica.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
