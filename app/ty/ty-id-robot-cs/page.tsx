    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Váš NovaClean X1 PRO + OMNI Stanice se připravuje a brzy bude odeslán.
        </p>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Platba při doručení</div>
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Připravte si přesnou částku (1970 Kč) pro kurýra</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          Máte otázky? Napište nám: <a href="mailto:info@ketronica.com" style={{ color: '#10b981', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
