    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          O seu Robô de Cozinha 12 em 1 está a ser preparado e será enviado em breve.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#047857', fontWeight: 600, marginBottom: '0.25rem' }}>NÚMERO DA ENCOMENDA</div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              ...
              <div style={{ color: '#64748b', fontSize: '0.8rem' }}>Em 24 horas</div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem' }}>
            ...
            <div>
              ...
              <div style={{ color: '#64748b', fontSize: '0.8rem' }}>2-4 dias úteis</div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Prepare o valor exato (109€) para o estafeta</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          Tem dúvidas? Escreva-nos: <a href="mailto:info@ketronica.com" style={{ color: '#10b981', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
