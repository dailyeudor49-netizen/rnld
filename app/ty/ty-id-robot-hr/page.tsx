    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Vaš NovaClean X1 PRO + OMNI Stanica se priprema i uskoro će biti poslan.
        </p>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Pripremite točan iznos (€79,99) za kurira</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          Imate pitanja? Pišite nam: <a href="mailto:info@ketronica.com" style={{ color: '#10b981', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
