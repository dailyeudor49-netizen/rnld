    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Váš Kuchyňský Robot 12 v 1 se připravuje a brzy bude odeslán.
        </p>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.75rem' }}>
            ...
            <div>
              ...
              <div style={{ color: '#64748b', fontSize: '0.8rem' }}>2-4 pracovní dny</div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Platba při převzetí</div>
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Připravte si přesnou částku (2 099 Kč) pro kurýra</div>
          </div>
        </div>
