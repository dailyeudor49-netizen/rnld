    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Jūsų kondicionierius Air Wave Smart™ ruošiamas ir netrukus bus išsiųstas.
        </p>
        ...
        <div style={{
          ...
          Klausimai? Susisiekite su mumis: <a href="mailto:info@ketronica.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
