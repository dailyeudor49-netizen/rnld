    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Vezeték nélküli porszívója előkészítés alatt áll, és hamarosan kiszállítjuk.
        </p>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Fizetés átvételkor</div>
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Készítse elő a pontos összeget (26 500 Ft) a futárnak</div>
          </div>
        </div>
