    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Twój NovaClean X1 PRO jest przygotowywany i wkrótce zostanie wysłany.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#047857', fontWeight: 600, marginBottom: '0.25rem' }}>NUMER ZAMÓWIENIA</div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.75rem' }}>
            ...
            <div>
              ...
              <div style={{ color: '#64748b', fontSize: '0.8rem' }}>2-4 dni robocze</div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Przygotuj dokładną kwotę (339 zł) dla kuriera</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          Masz pytania? Napisz do nas: <a href="mailto:info@ketronica.com" style={{ color: '#10b981', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
