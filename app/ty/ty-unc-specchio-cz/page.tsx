    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ color: '#6b7280', fontSize: '0.95rem', marginBottom: '1.5rem', lineHeight: 1.5 }}>
          Váš MirrorCam 4K Duo se připravuje a brzy bude odeslán.
        </p>
        ...
        <div style={{ fontSize: '0.85rem', color: '#64748b', marginBottom: '1.5rem' }}>
          Dotazy? Napište nám na <a href="mailto:info@ketronica.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
