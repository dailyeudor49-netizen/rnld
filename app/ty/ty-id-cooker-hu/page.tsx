    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Az Ön 12 az 1-ben Konyhai Robotja előkészítés alatt áll és hamarosan kiszállításra kerül.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#047857', fontWeight: 600, marginBottom: '0.25rem' }}>RENDELÉSSZÁM</div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.75rem' }}>
            ...
            <div>
              ...
              <div style={{ color: '#64748b', fontSize: '0.8rem' }}>2-4 munkanap</div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Utánvételes fizetés</div>
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Készítse elő a pontos összeget (35 582 Ft) a futárnak</div>
          </div>
        </div>
