    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          O seu Secador Costway 800W está a ser preparado e será enviado em breve.
        </p>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Pagamento à cobrança</div>
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Prepare o valor exato (79€) para o estafeta</div>
          </div>
        </div>
