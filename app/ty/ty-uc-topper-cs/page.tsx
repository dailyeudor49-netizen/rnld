    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Váš ortopedický topper Soft Foam se připravuje a bude brzy odeslán.
        </p>
        ...
        <div style={{
          ...
          Máte dotazy? Napište nám na <a href="mailto:info@ketronica.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
