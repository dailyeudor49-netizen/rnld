    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Il tuo Aspirapolvere Senza Fili è in preparazione e sarà spedito a breve.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#047857', fontWeight: 600, marginBottom: '0.25rem' }}>NUMERO ORDINE</div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.75rem' }}>
            ...
            <div>
              ...
              <div style={{ color: '#64748b', fontSize: '0.8rem' }}>2-4 giorni lavorativi</div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Prepara l'importo esatto (129€) per il corriere</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          Hai domande? Scrivici: <a href="mailto:info@ketronica.com" style={{ color: '#10b981', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
