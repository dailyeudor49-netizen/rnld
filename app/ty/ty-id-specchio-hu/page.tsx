...
export default function ThankYouPage() {
  ...
  useEffect(() => {
    ...
    if (stored) {
      ...
      const newCode = 'MCC-' + Math.floor(100000 + Math.random() * 900000).toString();
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ color: '#6b7280', fontSize: '0.95rem', marginBottom: '1.5rem', lineHeight: 1.5 }}>
          Az Ön MirrorCam 4K Duo előkészítés alatt áll, és hamarosan kiszállítjuk.
        </p>
        ...
        <div style={{ background: '#FEF3C7', borderRadius: '12px', padding: '1rem', marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.75rem', textAlign: 'left' }}>
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Utánvéttel fizetés</div>
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Készítse elő a pontos összeget a futárnak</div>
          </div>
        </div>

        <div style={{ fontSize: '0.85rem', color: '#64748b', marginBottom: '1.5rem' }}>
          Kérdése van? Írjon nekünk: <a href="mailto:info@ketronica.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
