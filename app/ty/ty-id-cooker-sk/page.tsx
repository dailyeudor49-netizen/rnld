    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Váš Kuchynský Robot 12 v 1 sa pripravuje a čoskoro bude odoslaný.
        </p>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.75rem' }}>
            ...
            <div>
              ...
              <div style={{ color: '#64748b', fontSize: '0.8rem' }}>2-4 pracovné dni</div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Platba pri doručení</div>
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Pripravte si presnú sumu (€79,00) pre kuriéra</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          Máte otázky? Napíšte nám: <a href="mailto:info@ketronica.com" style={{ color: '#10b981', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
