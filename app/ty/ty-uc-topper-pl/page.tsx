    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Twoja nakładka ortopedyczna Soft Foam jest przygotowywana i wkrótce zostanie wysłana.
        </p>
        ...
        <div style={{
          ...
          Pytania? Napisz do nas na <a href="mailto:info@ketronica.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@ketronica.com</a>
        </div>
