...
export default function LandingPage() {
  ...
  return (
    <>
      ...
      {/* Click Pixel */}
      <img
        src="https://offers.uncappednetwork.com/forms/api/ck/?o=1851&uid=019a913a-422a-770d-8b80-6aa9c3b58776&lp=1871"
          ...
          <div className="product-info">
            ...
            <div className="product-price">
              <div className="price-row">
                ...
                <span className="price-original">249,00 €</span>
            ...
            <div style={{ background: 'rgba(255,255,255,0.05)', padding: '2rem', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.1)' }}>
              ...
              <ul style={{ color: '#cbd5e1', listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                  <span>Kataložna cijena</span> <span style={{ textDecoration: 'line-through' }}>249,00 €</span>
                </li>
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                  <span>Black Friday popust</span> <span style={{ color: '#FFB800' }}>-150,00 €</span>
                </li>
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                ...
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '1rem 0', fontSize: '1.25rem', fontWeight: 700, color: 'white' }}>
                  <span>Ukupno</span> <span>99,00 €</span>
                </li>
              </ul>
          ...
          <div className="sticky-info" style={{
            ...
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <span style={{ fontSize: '1.25rem', fontWeight: 800, color: '#16a34a' }}>99,00 €</span>
                <span style={{ fontSize: '0.875rem', textDecoration: 'line-through', color: 'white', opacity: 0.8 }}>249,00 €</span>
              </div>
            </div>
          </div>
          <button
