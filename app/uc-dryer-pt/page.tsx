...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; outline: none; -webkit-tap-highlight-color: transparent; }
  ...
  .promo-strip { background: #fff3cd; color: #856404; text-align: center; padding: 10px 0; font-weight: 600; font-size: 1rem; border-bottom: 1px solid #ffeeba; margin-top: 64px; }
    ...
    <>
        ...
        <div className="container">
          <div className="hero-visual">
            <div className="hero-img-container">
              <img src="https://placehold.co/600x600/e0e0e0/333333?text=Secador+Costway+800W" alt="Secador" width="600" height="600" />
              <div className="overlay-badge">⭐ 4,8/5</div>
            </div>
            <div className="hero-badges text-center">
              <span>⚡ 800W Potência</span>
              <span>🌡️ Até 69°C</span>
          ...
          <div className="hero-content">
            <h1>SECA E PARA SOZINHA — SEM DESPERDÍCIOS</h1>
            ...
            <ul className="check-list mb-3">
              <li><strong>Menos desperdícios:</strong> Sensor Auto-Stop quando a roupa está seca</li>
              <li><strong>Prática e Manuseável:</strong> Pequena e leve, ideal para espaços reduzidos</li>
              <li><strong>Higiene profunda:</strong> Temperatura até 69°C</li>
              <li><strong>Anti-emaranhamento:</strong> Rotação bidirecional inteligente</li>
              <li><strong>Controlo total:</strong> 4 temperaturas + 6 temporizadores</li>
              <li><strong>Instalação 3-em-1:</strong> Parede, livre ou empilhada</li>
            </ul>

            <button onClick={scrollToOrder} className="btn btn-pulse">ENCOMENDAR AGORA — PAGAMENTO À COBRANÇA</button>

            <div className="trust-pills">
              <div>📦 Envio Rápido</div>
              <div>🛡️ Garantia 2 Anos</div>
              <div>🤝 Assistência Dedicada</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="container">
        <div className="product-box">
          <h3 className="text-center">RESUMO DA OFERTA</h3>
          <div className="flex items-center justify-between mb-2">
            <div>
              <strong>Secador Costway 800W</strong><br/>
          ...
          <div style={{fontSize: '1rem', marginBottom: '15px', color: '#555', background: '#f4f6f8', padding: '12px', borderRadius: '4px'}}>
            ✅ Classe Energética C<br/>
            ✅ Dimensões: 48 × 40 × 56 cm<br/>
            ✅ Pagamento cómodo à cobrança
          </div>
          <button onClick={scrollToOrder} className="btn">QUERO RECEBER EM CASA</button>
          <p className="text-center mt-2" style={{fontSize: '0.9rem', color: '#d32f2f'}}>🔥 A este preço restam apenas poucas unidades</p>
        </div>
      </section>

      {/* 4. BENEFITS */}
      <section className="container">
        <h2 className="text-center mb-3">ESQUEÇA O PROBLEMA DE ESTENDER ROUPA</h2>
        <div className="benefits-grid">
          <div className="benefit-card">
            <span className="benefit-icon">🛑</span>
            <h4>MENOS DESPERDÍCIOS</h4>
            <p style={{fontSize:'1rem'}}>Graças ao sensor NTC, para sozinha quando a roupa está seca.</p>
          </div>
          <div className="benefit-card">
            <span className="benefit-icon">💰</span>
            <h4>PREÇO INTELIGENTE</h4>
            <p style={{fontSize:'1rem'}}>Desempenho de alto nível sem gastar 600€+ em máquinas volumosas.</p>
          </div>
          <div className="benefit-card">
            <span className="benefit-icon">👕</span>
            <h4>MENOS VINCOS</h4>
            <p style={{fontSize:'1rem'}}>A rotação frente/trás reduz os emaranhados facilitando a engomagem.</p>
          </div>
          <div className="benefit-card">
            <span className="benefit-icon">🎛️</span>
            <h4>CONTROLO TOTAL</h4>
            <p style={{fontSize:'1rem'}}>4 modos de calor e 6 temporizadores para tratar cada tecido como merece.</p>
          </div>
        </div>
      </section>
      ...
      <div className="stats-bar">
        <div className="container">
          <h3 style={{color:'white', marginBottom: '20px'}}>NÚMEROS QUE FALAM</h3>
          <div className="stats-grid">
            ...
            <div className="stat-item">
              ...
              <span className="stat-label">Peso Líquido</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="feature-row">
          ...
          <div className="feature-content">
            ...
            <ul className="micro-bullets">
              <li>Protege os tecidos do calor excessivo</li>
              <li>Otimiza o consumo energético</li>
            </ul>
          </div>
        </div>

        <div className="feature-row">
          <img src="https://placehold.co/500x350/f0f0f0/333?text=Tecnologia+69+Graus" alt="Temperatura 69 Graus" className="feature-img" />
          <div className="feature-content">
            ...
            <ul className="micro-bullets">
              <li>Secagem profunda e rápida</li>
              <li>Ideal para roupa interior e toalhas</li>
            </ul>
          </div>
        </div>

        <div className="feature-row">
            <img src="https://placehold.co/500x350/f0f0f0/333?text=Tambor+Inox+Bidirecional" alt="Tambor Inox" className="feature-img" />
            <div className="feature-content">
                ...
                <ul className="micro-bullets">
                    <li>Roupa menos amarrotada</li>
                    <li>Engomagem muito mais fácil e rápida</li>
                </ul>
            </div>
        </div>

        <div className="feature-row">
            <img src="https://placehold.co/500x350/f0f0f0/333?text=Nao+Ocupa+Espaco" alt="Poupança Espaço" className="feature-img" />
            <div className="feature-content">
                ...
                <ul className="micro-bullets">
                    <li>Compactíssima: cabe mesmo em espaços "normais"</li>
                    <li>Instalação flexível: parede / apoio / empilhável</li>
                    <li>Praticidade total: pequenas cargas quando precisa, sem esperar</li>
                </ul>
            </div>
        </div>
      </section>
      ...
      <section className="container bg-gray" style={{padding: '30px', borderRadius: '8px', marginTop: '30px'}}>
        <h2 className="text-center">ESPECIFICAÇÕES TÉCNICAS</h2>
        <table className="specs-table">
            <tbody>
              <tr><td><strong>Dimensões</strong></td><td>48 × 40 × 56 cm</td></tr>
              <tr><td><strong>Peso Líquido</strong></td><td>16,4 kg</td></tr>
              <tr><td><strong>Capacidade</strong></td><td>Até 5 kg (Máx)</td></tr>
              <tr><td><strong>Potência</strong></td><td>800 W</td></tr>
              <tr><td><strong>Voltagem/Freq.</strong></td><td>220–240V / 50–60Hz</td></tr>
              <tr><td><strong>Ruído</strong></td><td>Silenciosa (Padrão doméstico)</td></tr>
              <tr><td><strong>Conteúdo</strong></td><td>1 Secador, 1 Escape, 1 Manual</td></tr>
            </tbody>
        </table>
      </section>
      ...
      {/* 10. REVIEWS */}
      <section className="container">
        <h2 className="text-center mb-3">O QUE DIZEM OS CLIENTES</h2>
        <p className="text-center mb-3">Avaliação média: ⭐ 4,8/5 (697 avaliações)</p>

        <div className="review-card">
            <div className="review-header">
                <strong>Ana R. (Lisboa)</strong>
                <span>Há 5 dias</span>
            </div>
            <div className="verified-badge">✅ Compra verificada</div>
            <p>"Vivo num estúdio e este secador salvou-me a vida. Já não tenho o estendal no meio da sala. Seca bem, o sensor funciona mesmo: para quando a roupa está pronta."</p>
        </div>

        <div className="review-card">
            <div className="review-header">
                <strong>Miguel T. (Porto)</strong>
                <span>Há 1 semana</span>
            </div>
            <div className="verified-badge">✅ Compra verificada</div>
            <p>"No início estava cético pelo tamanho, mas é perfeita para as minhas necessidades. A roupa sai quente e macia. Consome o justo se usada com inteligência."</p>
            <div className="seller-reply">
                <strong>Resposta do vendedor:</strong> Obrigado Miguel! Ficamos felizes que o produto corresponda às suas expectativas.
            </div>
        </div>
      </section>
      ...
      {/* 12. STEPS */}
      <section className="container">
          <h2 className="text-center" style={{marginTop: '40px'}}>COMO ENCOMENDAR</h2>
          <div className="steps-container">
              <div className="step-item">
                  <div className="step-num">1</div>
                  <div className="step-title">Preencha</div>
                  <div className="step-desc">Introduza os seus dados no formulário.</div>
              </div>
              <div className="step-item">
                  <div className="step-num">2</div>
                  <div className="step-title">Confirme</div>
                  <div className="step-desc">O pedido é processado imediatamente.</div>
              </div>
              <div className="step-item">
                  <div className="step-num">3</div>
                  <div className="step-title">Pague</div>
                  <div className="step-desc">Paga em dinheiro ao estafeta.</div>
              </div>
          </div>
      </section>
      ...
      <section id="order-form" className="order-dark-section">
        <div className="container">
            <div className="red-pill">Restam apenas 4 unidades a este preço</div>
            <h1 className="text-center text-white mb-2" style={{color:'white', fontSize: '3rem'}}>Encomende Agora</h1>
            <p className="text-center mb-3" style={{color: '#9ca3af'}}>Preencha o formulário. Paga apenas na entrega.</p>
            ...
            <form className="form-card" onSubmit={handleOrderSubmit}>
                ...
                <div className="product-highlight">
                    <div className="flex justify-between items-start">
                        <div>
                            <h3 style={{fontSize: '1.2rem', margin:0}}>Secador Costway 800W</h3>
                    ...
                    <div style={{marginTop: '10px'}}>
                        <span className="tag-badge">ENVIO GRÁTIS</span>
                        <span className="tag-badge tag-badge-blue">GARANTIA 2 ANOS</span>
                    </div>

                    {/* Timer Red Box */}
                    <div className="timer-red-box">
                        <span style={{fontSize: '1.2rem'}}>⏱</span> Oferta expira em: {formatTime(timeLeft)}
                    </div>
                </div>
                ...
                <button type="submit" className="blue-btn">
                    ENCOMENDAR AGORA — PAGAR NA ENTREGA <span style={{fontSize:'1.3rem'}}>🚚</span>
                </button>

                <div className="secure-note">
                    <span>🔒</span> Os seus dados estão protegidos e encriptados com SSL. Usamo-los APENAS para o envio.
                </div>
      ...
      <section className="container" style={{marginTop: '40px', marginBottom: '60px'}}>
        <h2 className="text-center mb-3">PERGUNTAS FREQUENTES</h2>

        {[
          {
            q: "Precisa de um esgoto?",
            a: "Não, não precisa de uma tubagem de água como a máquina de lavar. Este é um secador de ventilação (venting). O ar húmido é expelido através do condutor de escape (incluído)."
          },
          {
            q: "Quanto consome realmente?",
            a: "A potência é de 800W. Fórmula estimada: 0,8 kW × Horas. Se um ciclo durar 2 horas e a energia custar 0,30€/kWh, gasta aproximadamente 0,48€ por ciclo."
          },
          {
            q: "É difícil de instalar?",
            a: "De todo. Chega já montada. Só tem de ligar a ficha e o tubo de escape na parte traseira."
          },
          {
            q: "Quanta roupa posso colocar?",
            a: "Capacidade máxima 5 kg (molhado). Ideal para secar camisolas, roupa interior, toalhas e lençóis."
          }
        ].map((faq, i) => (
